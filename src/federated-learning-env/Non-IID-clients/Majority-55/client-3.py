...
x_train3 = x_train3[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
y_train3 = y_train3[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
x_test3 = x_test3[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
y_test3 = y_test3[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
