...
x_train1 = x_train1[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train1 = y_train1[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test1 = x_test1[majorityTest+minorityTest*(int(clientID)-2):]
y_test1 = y_test1[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train2 = x_train2[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train2 = y_train2[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test2 = x_test2[majorityTest+minorityTest*(int(clientID)-2):]
y_test2 = y_test2[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train3 = x_train3[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train3 = y_train3[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test3 = x_test3[majorityTest+minorityTest*(int(clientID)-2):]
y_test3 = y_test3[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train4 = x_train4[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train4 = y_train4[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test4 = x_test4[majorityTest+minorityTest*(int(clientID)-2):]
y_test4 = y_test4[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train5 = x_train5[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train5 = y_train5[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test5 = x_test5[majorityTest+minorityTest*(int(clientID)-2):]
y_test5 = y_test5[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train6 = x_train6[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train6 = y_train6[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test6 = x_test6[majorityTest+minorityTest*(int(clientID)-2):]
y_test6 = y_test6[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train7 = x_train7[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train7 = y_train7[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test7 = x_test7[majorityTest+minorityTest*(int(clientID)-2):]
y_test7 = y_test7[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train8 = x_train8[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train8 = y_train8[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test8 = x_test8[majorityTest+minorityTest*(int(clientID)-2):]
y_test8 = y_test8[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train9 = x_train9[majorityTrain+minorityTrain*(int(clientID)-2):]
y_train9 = y_train9[majorityTrain+minorityTrain*(int(clientID)-2):]
x_test9 = x_test9[majorityTest+minorityTest*(int(clientID)-2):]
y_test9 = y_test9[majorityTest+minorityTest*(int(clientID)-2):]
...
x_train10 = x_train10[minorityTrain*(int(clientID)-1):]
y_train10 = y_train10[minorityTrain*(int(clientID)-1):]
x_test10 = x_test10[minorityTest*(int(clientID)-1):]
y_test10 = y_test10[minorityTest*(int(clientID)-1):]
