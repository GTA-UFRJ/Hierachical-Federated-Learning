...
x_train7 = x_train7[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
y_train7 = y_train7[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
x_test7 = x_test7[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
y_test7 = y_test7[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
