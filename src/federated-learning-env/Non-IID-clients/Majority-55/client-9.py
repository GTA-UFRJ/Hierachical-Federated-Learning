...
x_train6 = x_train6[majorityTrain+minorityTrain*(int(clientID)-2):majorityTrain+minorityTrain*(int(clientID)-1)+1]
y_train6 = y_train6[majorityTrain+minorityTrain*(int(clientID)-2):majorityTrain+minorityTrain*(int(clientID)-1)+1]
x_test6 = x_test6[majorityTest+minorityTest*(int(clientID)-2):majorityTest+minorityTest*(int(clientID)-1)+1]
y_test6 = y_test6[majorityTest+minorityTest*(int(clientID)-2):majorityTest+minorityTest*(int(clientID)-1)+1]
...
x_train7 = x_train7[majorityTrain+minorityTrain*(int(clientID)-2):majorityTrain+minorityTrain*(int(clientID)-1)+1]
y_train7 = y_train7[majorityTrain+minorityTrain*(int(clientID)-2):majorityTrain+minorityTrain*(int(clientID)-1)+1]
x_test7 = x_test7[majorityTest+minorityTest*(int(clientID)-2):majorityTest+minorityTest*(int(clientID)-1)+1]
y_test7 = y_test7[majorityTest+minorityTest*(int(clientID)-2):majorityTest+minorityTest*(int(clientID)-1)+1]
...
x_train8 = x_train8[majorityTrain+minorityTrain*(int(clientID)-2):majorityTrain+minorityTrain*(int(clientID)-1)+1]
y_train8 = y_train8[majorityTrain+minorityTrain*(int(clientID)-2):majorityTrain+minorityTrain*(int(clientID)-1)+1]
x_test8 = x_test8[majorityTest+minorityTest*(int(clientID)-2):majorityTest+minorityTest*(int(clientID)-1)+1]
y_test8 = y_test8[majorityTest+minorityTest*(int(clientID)-2):majorityTest+minorityTest*(int(clientID)-1)+1]
...
x_train9 = x_train9[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
y_train9 = y_train9[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
x_test9 = x_test9[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
y_test9 = y_test9[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
