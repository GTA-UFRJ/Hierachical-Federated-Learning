...
x_train8 = x_train8[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
y_train8 = y_train8[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
x_test8 = x_test8[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
y_test8 = y_test8[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
