...
x_train5 = x_train5[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
y_train5 = y_train5[minorityTrain*(int(clientID)-1):majorityTrain+minorityTrain*(int(clientID)-1)]
x_test5 = x_test5[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
y_test5 = y_test5[minorityTest*(int(clientID)-1):majorityTest+minorityTest*(int(clientID)-1)]
