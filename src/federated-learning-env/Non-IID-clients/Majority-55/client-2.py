...
x_train1 = x_train1[majorityTrain:majorityTrain+minorityTrain+1]
y_train1 = y_train1[majorityTrain:majorityTrain+minorityTrain+1]
x_test1 = x_test1[majorityTest:majorityTest+minorityTest+1]
y_test1 = y_test1[majorityTest:majorityTest+minorityTest+1]
...
x_train2 = x_train2[minorityTrain:majorityTrain+minorityTrain]
y_train2 = y_train2[minorityTrain:majorityTrain+minorityTrain]
x_test2 = x_test2[minorityTest:majorityTest+minorityTest]
y_test2 = y_test2[minorityTest:majorityTest+minorityTest]
...
x_train5 = x_train5[minorityTrain*(int(clientID)-1):minorityTrain*int(clientID)+1]
y_train5 = y_train5[minorityTrain*(int(clientID)-1):minorityTrain*int(clientID)+1]
x_test5 = x_test5[minorityTest*(int(clientID)-1):minorityTest*int(clientID)+1]
y_test5 = y_test5[minorityTest*(int(clientID)-1):minorityTest*int(clientID)+1]
...
x_train6 = x_train6[minorityTrain*(int(clientID)-1):minorityTrain*int(clientID)+1]
y_train6 = y_train6[minorityTrain*(int(clientID)-1):minorityTrain*int(clientID)+1]
x_test6 = x_test6[minorityTest*(int(clientID)-1):minorityTest*int(clientID)+1]
y_test6 = y_test6[minorityTest*(int(clientID)-1):minorityTest*int(clientID)+1]
