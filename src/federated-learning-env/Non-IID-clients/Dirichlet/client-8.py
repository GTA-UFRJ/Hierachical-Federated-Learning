...
# first class
x_data = np.asarray(load(open('../../../../datasets/CIFAR-10/direchlet-partition/client_8_samples','rb')))
y_data = np.asarray(load(open('../../../../datasets/CIFAR-10/direchlet-partition/client_8_class','rb')))
