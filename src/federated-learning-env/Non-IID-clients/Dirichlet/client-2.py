...
# first class
x_data = np.asarray(load(open('../../../../datasets/CIFAR-10/direchlet-partition/client_2_samples','rb')))
y_data = np.asarray(load(open('../../../../datasets/CIFAR-10/direchlet-partition/client_2_class','rb')))
...
#        with open('weights/client-2-weights','wb') as writeFile:
