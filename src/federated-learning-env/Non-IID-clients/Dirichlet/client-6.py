...
# first class
x_data = np.asarray(load(open('../../../../datasets/CIFAR-10/direchlet-partition/client_6_samples','rb')))
y_data = np.asarray(load(open('../../../../datasets/CIFAR-10/direchlet-partition/client_6_class','rb')))
...
#        with open('weights/client-6-weights','wb') as writeFile:
